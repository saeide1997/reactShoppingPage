    ...
    return (
        <div className=' bg-slate-200'>
            <div className='p-7 flex justify-between items-center'>
                ...
                <div className='flex-1 text-center text-[40px]'>.SOHO</div>
                <div className='flex-1 flex justify-end'>
                    <div className='mx-3 text-[20px] cursor-pointer'>ثبت نام</div>
                    <div className='mx-3 text-[20px] cursor-pointer'>ورود</div>
