import { Facebook, Instagram, Mail, MailOutline, Phone, Room, Twitter } from '@mui/icons-material';
    ...
    return (
        <div className='flex'>
            ...
            <div className='flex-1 p-5'>
                ...
                <div className='mb-3 flex items-center'><Room className='ml-2'/>ایران. تبریز. الهی پرست</div>
                <div className='mb-3 flex items-center'><Phone className='ml-2'/>09144839748</div>
                <div className='mb-3 flex items-center'><MailOutline className='ml-2'/>Saeiide.tm@gmail.com</div>
                <img src="" alt="" />
